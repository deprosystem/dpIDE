function uiSwipeLayout() {
   
    this.newElementUI = function(p) {
        p.componParam = {type:26,nodel:true,noact:true,nomove:true,nodrop:true};
        return null;
    }
    ...
    this.getHelpLink = function() {
        return "https://docs.google.com/document/d/1iYRvK_JAz67laVPot_pCEUa0sM9Jp3hSJZMMG4qmtxQ/edit#bookmark=id.ccppfgkrtmnk";
    }
}