function uxPhoto() {
    ...
    this.setValue = function(componParam) {
        ...
        let dd = new EditForm(meta, currentComponentDescr.view, componParam, null, this);
    };
    ...
    this.isValid = function(compD) {
        ...
        let vv = compD.view;
        if (vv.tabLayout == null || vv.tabLayout.length == 0) {
            err.text += txtError(2, tab, "component " + compD.view.viewId + " It is not specified where to show the image");
            err.error = 2;
        }
        return err;
    };
